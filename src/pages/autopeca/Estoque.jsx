...
const EstoquePage = () => {
  ...
  useEffect(() => {
    ...
    // Carregar produtos do localStorage ou criar produtos de exemplo se não existirem
    loadProducts();
  }, []);
  ...
  const loadProducts = () => {
    ...
    // Se não houver produtos ou forem menos de 5, criar produtos de exemplo
    if (savedProducts.length < 5) {
      const exampleProducts = [
        {
          ...
          imagemUrl: '/api/placeholder/100/100'
        },
        {
          id: '2',
          vendedorId: currentUser?.id || 'example_user',
      ...
      // Combinar produtos existentes com exemplos
      savedProducts = [...savedProducts, ...exampleProducts];
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      // Em uma aplicação real, aqui enviaria a imagem para um servidor
      // Para esta simulação, usaremos o URL.createObjectURL para preview
      const imageUrl = URL.createObjectURL(file);
      setNewProduct({
        ...newProduct,
        imagemPreview: imageUrl
      });
    }
  };
  ...
  const handleAddProduct = (e) => {
    ...
    const product = {
      ...
      quantidadeEstoque: parseInt(newProduct.quantidadeEstoque),
      imagemUrl: newProduct.imagemPreview || '/api/placeholder/100/100', // Em produção, seria URL real da imagem no servidor
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-12 w-12 rounded overflow-hidden bg-gray-100">
                        <img src={product.imagemUrl} alt={product.nome} className="h-12 w-12 object-cover" />
                      </div>
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900">{product.nome}</div>
                        <div className="text-sm text-gray-500 max-w-md truncate">{product.descricao}</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button className="text-red-500 hover:text-red-700">
                          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v10M9 7v10m10-7h.01" />
                          </svg>
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="oleos">Óleos e Fluídos</option>
                      ...
                      <div className="col-span-2">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="w-20 h-20 bg-gray-100 rounded flex items-center justify-center overflow-hidden">
                            {newProduct.imagemPreview ? (
                              <img src={newProduct.imagemPreview} alt="Preview" className="w-full h-full object-cover" />
                            ) : (
